...
class QB:
    ...
    def display(self):
        print("QB: " + self.name + ": " + str(self.completions) + "/" +
              str(self.attempts) + " " + str(self.passYards) + "yds.... " + str(self.td) + "TD")
...
class RB:
    ...
    def display(self):
        print("RB: " + self.name + ": " + str(self.carries) +
              " carries for " + str(self.yards) + "yds... " + str(self.td) + "TD")
...
class WR:
    ...
    def display(self):
        print(self.position + ": " + self.name + " -> " + str(self.receptions) +
              " receptions for " + str(self.yards) + "yds... " + str(self.td) + "TD")
...
class Game:
    ...
    def kickoff(self):
        ...
        print("GAME OVER")
        print(self.AwayTeam.name + ": " + str(self.AwayTeam.points) +
              " - " + self.HomeTeam.name + ": " + str(self.HomeTeam.points))
    ...
    def play(self):
        ...
        while (self.down <= 4 and self.yardline > 0):
            if (self.down == 1):
                ...
                n = "th"
            if (self.yardline > 50):
                print(str(self.down) + n + " & " + str(self.togo) +
                      "....^" + str(100 - self.yardline) + "yd-line")
            else:
                print(str(self.down) + n + " & " + str(self.togo) +
                      "....own " + str(self.yardline) + "yd-line")
    ...
    def passPlay(self, offense, distance):
        ...
        if (passplay < offense.qb.rating[distance]):
            # Completion
            print(offense.qb.name + " complete to " +
                  receiver.name + " for " + str(yards) + "yds.")
            offense.yards += yards
