...
class Game:
        ...
        def play(self):
                ...
                while (self.down <= 4 and self.yardline >0):
                        ...
                        if (self.down == 1):
                                ...
                                elif (playSelection <10, random.randint(0,2)):
                                        self.sackplay(self.possession)
                                            
                                else:
                                        self.passPlay(self.possession, random.randint(0,1))
                        elif (self.down == 2):
                                if (playSelection <= 10):
                                       self.sackplay(self.possession, random.randint(0,2)) 
                                elif(playSelection < 30):
                                        self.runPlay(self.possession)
                                ...
                                if (self.togo < 3 and playSelection > 10):
                                        if (playSelection < 60):
                                                self.runPlay(self.possession)
        
                                        else:
                                                self.passPlay(self.possession, random.randint(0,2))
                                elif (self.togo <= 8 and playSelection > 10):
                                    self.passPlay(self.possession, random.randint(0,1))

                                elif (playSelection <10):
                                    self.sackplay(self.possession, random.randint(0,1))

                                elif (self.togo > 8 and playSelection > 10 ):
                                    self.passPlay(self.possession, 2)
                                else:
                                    self.sackplay(self.possession, 2)    
                        else:
                                if (self.yardline >= 62):
                                        #Attempt Field Goal
        ...
        def runPlay(self,offense):
                ...
                if (self.yardline >= 100):
                        ...
                        offense.rb.td += 1
                        print("Touchdown!")
        def sackplay (self,offense) :
                if (distance == 0):
                    yards = random.randint(-3,-1)
                    print (offense.qb.name + "sack for" + str(yards) + "yds")
                    self.down += 1
                    self.togo -= yards
                    self.yardline += yards
                elif (distance == 1):
                    yards = random.randint(-7,-3)
                    print (offense.qb.name + "sack for" + str(yards) + "yds")
                    self.down += 1
                    self.togo -= yards
                    self.yardline += yards
                else:
                    yards = random.randint(-10,-5)   
                    print (offense.qb.name + "sack for" + str(yards) + "yds")
                    self.down += 1
                    self.togo -= yards
                    self.yardline += yards
                if (0 < self.yardline - yards):
                    print("safety!!!")
                    self.down=5
                    defense.points += 2
                else:
